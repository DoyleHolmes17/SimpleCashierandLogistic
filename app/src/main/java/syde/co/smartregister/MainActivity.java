...
//        }
        ...
        swipere.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Utils.saveSharedSetting(MainActivity.this, "statusrefresh", "true");
...
//                namabar = intent.getStringExtra("nama");
        ...
        screenShot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Screenshoot.takeScreenshot(MainActivity.this);
            }
        });
        ...
        cekHarga.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Utils.saveSharedSetting(MainActivity.this, "cekatautambah", "cek");
                startActivity(intent);
                finish();
            }
        });
        ...
        tambahBelanja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utils.saveSharedSetting(MainActivity.this, "cekatautambah", "tambahbelanja");
                Utils.saveSharedSetting(MainActivity.this, "statusrefresh", "false");
                startActivity(intent);
                finish();
            }
        });
...
//                Utils.saveSharedSetting(MainActivity.this, "backback", "2");
    ...
    public void clear(View view) {
        dbHandler.deleteAll();
        new AlertDialog.Builder(MainActivity.this).setTitle("Smart Register")
                .setCancelable(false)
                .setMessage("Delete semua daftar belanja berhasil. Silahkan swipe layar kebawah untuk refresh.")
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        intent = new Intent(MainActivity.this, HalamanKosong.class);
                        Utils.saveSharedSetting(MainActivity.this, "statHalkosong", "delcart");
                        finish();
                        startActivity(intent);
                    }
                }).show();
